...
Nhiredis is a .NET client for Redis. It is a fairly lightweight wrapper around hiredis, the recommend client for C developers. It exposes a simple, yet flexible API and it is _fast_.
